...
const Meeting: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-10 px-6 py-12 text-center bg-gray-950 min-h-screen">
      <h1 className="text-5xl font-bold text-white">Welcome to MeshSpire</h1>
