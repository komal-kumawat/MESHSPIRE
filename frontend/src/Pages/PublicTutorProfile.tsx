              ...
              <div className="px-6 sm:px-8 pb-8">
                <div className="flex flex-col items-center -mt-20">
                  ...
                  <div className="text-center mt-4">
                    ...
                    <span className="inline-block px-4 py-1.5 bg-gradient-to-r from-emerald-600/20 to-green-600/20 border border-emerald-500/30 rounded-full text-emerald-400 text-sm font-semibold">
                      {user.role}
                    </span>
                  </div>
                </div>
                        ...
                        {user.experience && (
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-lg bg-emerald-600/20 flex items-center justify-center">
                              <WorkHistoryIcon className="text-emerald-400 text-lg" />
                            </div>
                            <div>
                        ...
                        {user.hourlyRate && (
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-lg bg-green-600/20 flex items-center justify-center">
                              <AttachMoneyIcon className="text-green-400 text-lg" />
                            </div>
                            <div>
                              <p className="text-xs text-gray-400">
                                Hourly Rate
                  ...
                  {user.resume && (
                    <div className="bg-slate-800/40 border border-white/10 rounded-xl p-6 backdrop-blur-sm hover:border-emerald-500/30 transition-all">
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600/20 hover:bg-emerald-600/30 border border-emerald-500/30 rounded-lg text-emerald-300 transition-all"
                      >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {user.document.map((doc, idx) => (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-3 py-1.5 bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 rounded-lg text-green-300 text-sm transition-all"
                          >
                            Document {idx + 1}
                          </a>
                        ))}
