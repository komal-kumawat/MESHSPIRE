                    ...
                    >
                        ...
                        <div className="md:w-2/3 p-6 sm:p-8 flex flex-col gap-5 sm:gap-6 overflow-y-auto scrollbar-thin scrollbar-thumb-violet-800 scrollbar-track-slate-900 max-h-[80vh] md:max-h-[90vh]">
                            ...
                            <button
                                type="submit"
                                disabled={saving}
                                className={`mt-4 sm:mt-6 w-full py-2 sm:py-3 rounded-2xl font-semibold text-base sm:text-lg shadow-lg transition-all duration-300 ${saving
                            ...
                            {message && (
                                <p
                                    className={`text-center mt-3 sm:mt-4 font-medium transition-all duration-300 ${message.includes("success")
                                        ? "text-green-400"
                                        : "text-red-400"
                                        }`}
                                >
